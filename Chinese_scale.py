# Program to generate the sounds of notes of an Chinese scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a Chinese scale
    notes_interval = [4, 2, 1, 4, 1, 1] #4 - 2 - 1 - 4 - 1
    rev_interval = [0, 1, 4, 1, 2, 4]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} as root note in the Chinese scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} as root note in the Chinese scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the Chinese scale    
...
# Scale list for which the Chinese scale will be played in sequence
scale_list = ['C4']
